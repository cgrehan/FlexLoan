<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand" style="background: #fff">
        ...
        <a href="index.html" class="brand-logo">
            <img alt="Logo" src="{{asset("assets/media/logos/flexpay-logo.svg")}}" width="150"/>
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
            ...
            <ul class="menu-nav">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route("interests.index")}}" class="menu-link">
                                    ...
                                    <span class="menu-text">Manage Interests</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route("interest-types.index")}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Interest Types</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Credit Scores</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route("credit-scores.index")}}" class="menu-link">
                                    ...
                                    <span class="menu-text">Manage Credit Scores</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route("credit-score-types.index")}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Penalities</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route("penality-types.index")}}" class="menu-link">
                                    ...
                                    <span class="menu-text">Penality Types</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="{{route("loan-types.index")}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Loan Types</span>
                    </a>
                </li>
            </ul>
            <!--end::Menu Nav-->
