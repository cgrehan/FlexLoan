                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div v-if="show">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-solid form-control-lg" v-model="details.other_income_earning">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="border-bottom mb-5 pb-5">
                                ...
                                <div class="line-height-md" v-if="details.is_employed">
                                    ...
                                    <br />
                                    Other Source of Income Earnings: {{details.other_income_earning}} <br />
...
export default {
    ...
    data(){
        return {
            ...
            details:{address1:'',address2:'',postcode:'',city:'',is_employed:1,salary:'',other_income_earning:'',company_name:'',company_phone:'',employer_name:'',first_next_of_kin_name:'',first_next_of_kin_phone:'',first_next_of_kin_relationship:'',
    ...
    methods: {
        ...
        getDetails(){
            this.user.first_name = this.user_detail.first_name;
            this.user.last_name = this.user_detail.last_name;
            this.user.email = this.user_detail.email;
            this.user.gender = this.user_detail.gender;
            this.user.phone = this.user_detail.phone;
